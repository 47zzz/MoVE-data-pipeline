#!/bin/bash
# ============================================================
# 02_run_inference.sh - TTS Inference
# ============================================================
#
# Usage:
...
if [ ! -f "$SQUASH_FILE" ]; then
    echo "ERROR: Squash file $SQUASH_FILE not found!"
    echo "Please run 01_prepare.sh first to import the container."
    exit 1
fi

# Create temporary enroot container
CONTAINER_NAME="5emo-infer-${JOB_ID}-$$"
